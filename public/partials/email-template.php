<div style="max-width:100%;border:1px solid gainsboro;padding:15px;border-radius:5px;">
    ...
    <strong style="font-size:18px;">INTAKE</strong><hr>
    <table width="100%" style="border-collapse: collapse;border: 1px solid gainsboro;">
        <tr>
    ...
    <strong style="font-size:18px;">EXTERNAL PERIMETER CHECKS</strong><hr>
    <table width="100%" style="border-collapse: collapse;border: 1px solid gainsboro;">
        <tr>
            <td style="border: 1px solid gainsboro;"><strong>Shift</strong></td>
        ...
        <tr>
            ...
            <td style="border: 1px solid gainsboro;" ><?=isset($post['epc_date'])?$post['epc_date']:''?></td>
    ...
    <strong style="font-size:18px;">INTERNAL CHECKS</strong><hr>
    <table width="100%" style="border-collapse: collapse;border: 1px solid gainsboro;">
        <tr>
            <td style="border: 1px solid gainsboro;"><strong>Shift</strong></td>
            <td style="border: 1px solid gainsboro;" ><strong>Date</strong></td>
        ...
        <tr>
            ...
            <td style="border: 1px solid gainsboro;" ><?=isset($post['ic_date'])?$post['ic_date']:''?></td>
    ...
    <strong style="font-size:18px;">MAINTENANCE CONCERNS</strong><hr>
    <table width="100%" style="border-collapse: collapse;border: 1px solid gainsboro;">
        <tr>
            <td style="border: 1px solid gainsboro;"><strong>Shift</strong></td>
            <td style="border: 1px solid gainsboro;" ><strong>Date</strong></td>
        ...
        <tr>
            ...
            <td style="border: 1px solid gainsboro;" ><?=isset($post['mc_date'])?$post['mc_date']:''?></td>
    ...
    <br><br>
    <strong style="font-size:18px;">RECREATION</strong><hr>
    <table width="100%" style="border-collapse: collapse;border: 1px solid gainsboro;">
        <tr>
    ...
    <strong style="font-size:18px;">OUTSIDE HOSPITAL POSTS</strong><hr>
    <table width="100%" style="border-collapse: collapse;border: 1px solid gainsboro;">
        <tr>
    ...
    <strong style="font-size:18px;">DOC WATCHES</strong><hr>
    <table width="100%" style="border-collapse: collapse;border: 1px solid gainsboro;">
        <tr>
    ...
    <br><br>
    <strong style="font-size:18px;">SPG CELL SEARCHES</strong><hr>
    ...
    <br><br>
    <strong style="font-size:18px;">CELL DOOR/BAR CHECKS</strong><hr>
    ...
    <strong style="font-size:18px;">GENERAL CELL SEARCHES</strong><hr>
    <table width="100%" style="border-collapse: collapse;border: 1px solid gainsboro;">
        <tr>
            <td style="border: 1px solid gainsboro;"><strong>Shift</strong></td>
    ...
    <strong style="font-size:18px;">COMMON AREA SEARCHES</strong><hr>
    <table width="100%" style="border-collapse: collapse;border: 1px solid gainsboro;">
        <tr>
            <td style="border: 1px solid gainsboro;"><strong>Shift</strong></td>
            <td style="border: 1px solid gainsboro;" ><strong>Cell</strong></td>
    ...
    <br><br>
    <strong style="font-size:18px;">PLEASE ATTACH A COPY OF ALL REPORTS FOR YOUR SHIFT</strong><hr>
    <table width="100%" style="border-collapse: collapse;border: 1px solid gainsboro;">
        <tr>
